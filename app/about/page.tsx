      ...
      <div className="max-w-4xl mx-auto px-6 py-32 relative z-10">
        ...
        <header className="mb-32 text-center">
          ...
          <motion.p
            ...
            className="text-lg text-slate-400 max-w-xl mx-auto font-light"
          >
        ...
        <motion.section
          ...
          className="mb-32"
        >
          <h2 className="text-3xl font-light text-slate-800 mb-12 text-center tracking-tight">What I Do</h2>
          <div className="space-y-6 text-slate-400 leading-loose text-center max-w-2xl mx-auto font-light">
            <p>
        ...
        <motion.section
          ...
          className="mb-32"
        >
          <h2 className="text-3xl font-light text-slate-800 mb-12 text-center tracking-tight">Tech Stack</h2>
          <div className="grid md:grid-cols-2 gap-16">
            <div className="text-center">
              <h3 className="font-light text-base text-slate-800 mb-4">Core</h3>
            ...
            <div className="text-center">
              <h3 className="font-light text-base text-slate-800 mb-4">Deployment</h3>
              <ul className="text-slate-400 text-sm space-y-2 font-light">
                <li>DigitalOcean</li>
                <li>Google Cloud</li>
                <li>Git & GitHub</li>
